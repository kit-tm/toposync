...
def plot_tradeoff(deviation_data, load_data,):
    ...
    ax1.set_xlabel("network load constraint [in traversed links]")
    ax1.set_ylabel("average delay deviation [in ms]", color='b')
    ...
    ax2.set_ylabel("average network load [in traversed links]", color='r')
