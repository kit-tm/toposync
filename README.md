...
## Use the prototype
 ...
 4. Using the ONOS web GUI (http://localhost:8181/onos/ui/index.html) you should see that the ONOS connected to the network and recognized some hosts.  ![alt blablu](https://raw.githubusercontent.com/kit-tm/toposync/master/onos_screen.pdf)
